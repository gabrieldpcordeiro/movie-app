...
const itemCard = ({navigation, item, currentTab,media}) => {
            ...
            <HStack space={2} alignItems='center' ml={2} mr={20} style={{maxWidth: 250}}>
                ...
                <VStack space={1} alignItems='flex-start'>
                    ...
                    <Button style={{backgroundColor: '#06b6d4', width: 200, height: 40}}
                            onPress={() => navigation.navigate('Details', {itemId: item.id,media: media, currentTab: currentTab, mediaType: item.media_type, title: item.original_title })}>More Details</Button>
                </VStack>
            </HStack>
        </Box>
    )
